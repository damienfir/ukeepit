...
namespace uKeepIt.MiniBurrow.Serialization
{
    public class Dictionary
    {
        ...
        private static DictionaryPair EmptyPair = new DictionaryPair(MiniBurrow.Static.EmptyByteSegment, MiniBurrow.Static.EmptyByteSegment, null);
    ...
    public class DictionaryPair
    {
        ...
        public ArraySegment<byte> AsBytes() { return Value.Array == null ? MiniBurrow.Static.NullByteSegment: Value; }
